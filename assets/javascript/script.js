...
$(document).on('DOMContentLoaded', function () {
    window.ityped.init(document.querySelector('.ityped'), {
        strings: ['HI THERE!', 'I’M IBIKUNLE OLAWALE', 'Web Designer & Developer!'],
        loop: true
    });
});
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    dropdownList.addEventListener("click", (e) => {
        if (e.target.tagName === "LI") {
            ...
            selectedPlanInput.value = selectedText; // Update hidden input value
...
document.getElementById("submit-button").addEventListener("click", function () {
    ...
    form.submit(); // Submits the form to the PHP file specified in the 'action' attribute
});
